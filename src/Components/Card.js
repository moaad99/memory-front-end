  ...
  const dispatch = useDispatch()
    return (
      ...
      <div className="card-body">
        ...
        <div className="bt">
        <div className="modif">
        <button type="button" style={{width:"100px"}} className="btn btn-outline-primary">  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
